...
try:
    ...
    # Knowledge tracers not available - define minimal stubs
    class BayesianKnowledgeTracer:
        pass

    class AttentiveKnowledgeTracer:
        pass
...
BKT_PARAMS_BY_CATEGORY = {
    "grammar": {
        "verb_present": {"p_L0": 0.4, "p_T": 0.2, "p_F": 0.05, "p_G": 0.8, "p_S": 0.2},
        "verb_past": {"p_L0": 0.2, "p_T": 0.15, "p_F": 0.08, "p_G": 0.75, "p_S": 0.25},
        "verb_future": {"p_L0": 0.1, "p_T": 0.12, "p_F": 0.1, "p_G": 0.7, "p_S": 0.3},
        "articles": {"p_L0": 0.3, "p_T": 0.18, "p_F": 0.06, "p_G": 0.78, "p_S": 0.22},
        "prepositions": {"p_L0": 0.25, "p_T": 0.16, "p_F": 0.07, "p_G": 0.72, "p_S": 0.28},
    },
    "vocabulary": {
        "basic": {"p_L0": 0.6, "p_T": 0.25, "p_F": 0.03, "p_G": 0.85, "p_S": 0.15},
        "intermediate": {"p_L0": 0.3, "p_T": 0.2, "p_F": 0.05, "p_G": 0.8, "p_S": 0.2},
        "advanced": {"p_L0": 0.1, "p_T": 0.15, "p_F": 0.08, "p_G": 0.75, "p_S": 0.25},
    },
    "pronunciation": {
        "basic": {"p_L0": 0.5, "p_T": 0.22, "p_F": 0.04, "p_G": 0.82, "p_S": 0.18},
        "advanced": {"p_L0": 0.2, "p_T": 0.18, "p_F": 0.06, "p_G": 0.78, "p_S": 0.22},
    },
}


# Mapa de dificuldade IRT por nível CEFR (Rasch Model-based)
CEFR_DIFFICULTY_MAP = {"A1": 0.2, "A2": 0.4, "B1": 0.6, "B2": 0.75, "C1": 0.85, "C2": 0.95}
    ...
    akt_params.update(
        {
            ...
            # Número de interações para considerar (aumentado para melhor context-awareness)
            "attention_window": 30,
    ...
    if "verb" in skill_lower:
        ...
        if "user_text" in context:
            ...
            if any(word in user_text for word in ["eu", "me", "minha"]):
                ...
                word in user_text for word in ["ele", "ela", "eles", "elas", "o", "a", "os", "as"]
            ):
                features["person"] = "3rd"
...
def get_relevant_skills_for_context(
    user_text: str, cefr_level: str, context_type: str = "production", max_skills: int = 50
) -> list[str]:
    """
    ...
    # present_indicators removed - not used in logic
