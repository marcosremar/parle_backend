...
class LearningPathModule(BaseModule):
    ...
    async def get_next_skill(self, user_id: str, cefr_level: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            next_skill = self.navigator.get_next_skill(
                user_id=user_id, mastery_list=skill_masteries, cefr_level=cefr_level
            )
    ...
    async def get_review_skills(self, user_id: str) -> dict[str, Any]:
        ...
        try:
            ...
            review_skills = self.navigator.get_review_skills(
                user_id=user_id, mastery_list=skill_masteries
            )
