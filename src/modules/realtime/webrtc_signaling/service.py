...
# Metrics setup removed (corrupted line)
...
class SignalingManager:
    ...
    async def send_to_client(self, client_id: str, message: dict) -> bool:
        ...
        if client_id in self.active_connections:
            try:
                ...
                increment_metric("service_initializations", labels={"service": "webrtc_signaling", "status": "error"})
    ...
    def get_router(self) -> APIRouter:
        """Get router with WebSocket endpoint"""
        router = APIRouter()
        ...
        async def websocket_endpoint(websocket: WebSocket, client_id: str):
            ...
            try:
                while True:
                    ...
                    # Basic signaling logic: broadcast to others (mesh)
...
class WebRTCSignalingService(BaseService):
    ...
    async def initialize(self) -> bool:
        ...
        try:
            # Update metrics
            increment_metric("service_initializations", labels={"service": "webrtc_signaling", "status": "success"})
