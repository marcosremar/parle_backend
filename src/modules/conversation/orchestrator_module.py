    ...
    async def process_turn(
        ...
        **kwargs
        ...
        try:
            ...
            # The orchestrator.process_turn expects audio_data (bytes) and sample_rate
            if audio_base64:
                ...
                # The orchestrator expects audio, so we'll need to handle this differently
                # For now, raise an error - text-only processing needs to be implemented
                raise NotImplementedError("Text-only processing not yet implemented in orchestrator module. Use audio_base64.")
            else:
