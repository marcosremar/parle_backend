"""
STT Service Standalone - Consolidated for Nomad deployment
"""
import uvicorn
import os
import sys
...
class MinimalService:
    ...
    def get_service_info(self):
        return {"service": "stt", "version": "1.0.0", "status": "running"}

minimal_service = MinimalService()
router = APIRouter()
add_standard_endpoints(router, minimal_service, "stt")
