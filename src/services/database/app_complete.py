...
try:
    ...
    from src.core.shared.models.config_models import DatabaseConfig
...
class MinimalService:
    ...
    def get_service_info(self):
        return {"service": "database", "version": "1.0.0", "status": "running"}

minimal_service = MinimalService()
router = APIRouter()
add_standard_endpoints(router, minimal_service, "database")
