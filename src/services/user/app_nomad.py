"""FastAPI app for User Service - Nomad version"""
from fastapi import FastAPI
import sys
from pathlib import Path

# Ajustar paths para estrutura do V2
current_dir = Path(__file__).parent
v2_root = current_dir.parent

# Adicionar paths ao sys.path
sys.path.insert(0, str(v2_root))
sys.path.insert(0, str(v2_root / "user"))
...
try:
    ...
    sys.path.insert(0, str(v2_root.parent / "src"))
...
try:
    ...
    # add_telemetry_middleware removed, "user")
except ImportError:
