...
try:
    from src.core.constants import DEFAULT_HTTP_TIMEOUT, DEFAULT_CONNECT_TIMEOUT
except ImportError:
...
class HTTPClient:
    ...
    @classmethod
    async def get_session(cls, timeout: Optional[aiohttp.ClientTimeout] = None) -> aiohttp.ClientSession:
        """
